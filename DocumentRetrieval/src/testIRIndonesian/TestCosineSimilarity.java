...
public class TestCosineSimilarity {
    ...
    public static void main(String[] args) {
        ...
        for (Posting temp : listDoc3) {
            System.out.println(temp);
        }
        
        System.out.println("");
        double similarity = index.getCosineSimilarity(listDoc1, listDoc2);
        System.out.println("similarity 1 & 2: " + similarity);
        double similarity2 = index.getCosineSimilarity(listDoc1, listDoc3);
        System.out.println("similarity 1 & 3: " + similarity2);
        double similarity3 = index.getCosineSimilarity(listDoc2, listDoc3);
        System.out.println("similarity 2 & 3: " + similarity3);
    }
}
